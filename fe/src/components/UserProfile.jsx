...
import { userQuery, userSavedPin, userCreatedPinsQuery } from "../utils/data";
import { client } from "../client";
import { MasonryLayout, Spinner } from "../components";
const randomImage = "https://source.unsplash.com/featured/1600x900";
...
const UserProfile = () => {
  ...
  useEffect(() => {
    if (text === 'Created') {
      ...
      const savedPinQuery = userCreatedPinsQuery(userId);
